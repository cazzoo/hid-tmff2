...
| **13** | **`analysis/13_periodic_wedge.md`** | **P3-5 verdict (🔴): periodic/ramp MAIN type 0x22 STALLs the firmware, wedges the wheel until re-enumeration; family unadvertised** |
