...
static bool t500rs_op_pop(struct t500rs_device_entry *t500rs,
                          struct t500rs_op *out) {
  unsigned long flags;
  bool ok = false;
...
static int t500rs_queue_op(struct t500rs_device_entry *t500rs,
                           const struct t500rs_op *op) {
  unsigned long flags;
  u16 next;
  int ret = 0;
  if (!t500rs || !op)
...
static int t500rs_do_set_gain_byte(struct t500rs_device_entry *t500rs,
                                   u8 device_gain_byte) {
...
static void t500rs_io_work_handler(struct work_struct *work) {
  struct t500rs_device_entry *t500rs =
      container_of(work, struct t500rs_device_entry, io_work);
  struct t500rs_op op;
